...
def main() -> None:
    ...
    run_parser.add_argument("-r", "--rebuild", action="store_true",
                            help="Force rebuild of build command and Docker image")
    run_parser.add_argument("-n", "--no-build", action="store_true",
    ...
    run_parser.add_argument("-c", "--clean", action="store_true",
                            help="Delete temp files after run")
    run_parser.add_argument("-t", "--timeout", type=int, metavar="SECS",
    ...
    init_parser.add_argument("--placeholders", action="store_true",
    ...
    clean_parser.add_argument("--image", action="store_true",
